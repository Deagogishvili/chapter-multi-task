...
from PROT.esm.esm.model.esm2 import ESM2
...
def load_model_and_alphabet_hub(model_name):
    ...
    return load_model_and_alphabet_core_classic(model_name, model_data, regression_data)


def load_model_and_alphabet_local(model_location, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing):
    ...
    if _has_regression_weights(model_name):
        ...
        regression_data = None
    return load_model_and_alphabet_core(model_name, model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing, regression_data)
...
def _load_model_and_alphabet_core_v2(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing):
    ...
    model = ESM2(
        ...
        adapters_layer=adapters_layer,
        rank_LoRA=rank_LoRA,
        gradient_checkpointing=gradient_checkpointing
    )
    return model, alphabet, state_dict

def _load_model_and_alphabet_core_classic_v2(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing):
    def upgrade_state_dict(state_dict):
        """Removes prefixes 'model.encoder.sentence_encoder.' and 'model.encoder.'."""
        prefixes = ["encoder.sentence_encoder.", "encoder."]
        pattern = re.compile("^" + "|".join(prefixes))
...
def load_model_and_alphabet_core(model_name, model_data, finetuning: str = "no finetuning", adapters_layer: int = 20, rank_LoRA: int = 6, gradient_checkpointing: int = None, regression_data=None):
    if regression_data is not None:
        model_data["model"].update(regression_data["model"])

    if model_name.startswith("esm2"):
        model, alphabet, model_state = _load_model_and_alphabet_core_v2(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing)
    else:
        model, alphabet, model_state = _load_model_and_alphabet_core_v1(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing)

    expected_keys = set(model.state_dict().keys())
    found_keys = set(model_state.keys())

    if regression_data is None:
        expected_missing = {"layers.0.adapter_fc1.weight", "layers.0.adapter_fc1.bias", "layers.0.adapter_fc2.weight", "layers.0.adapter_fc2.bias", "layers.1.adapter_fc1.weight", "layers.1.adapter_fc1.bias", "layers.1.adapter_fc2.weight", "layers.1.adapter_fc2.bias", "layers.2.adapter_fc1.weight", "layers.2.adapter_fc1.bias", "layers.2.adapter_fc2.weight", "layers.2.adapter_fc2.bias", "layers.3.adapter_fc1.weight", "layers.3.adapter_fc1.bias", "layers.3.adapter_fc2.weight", "layers.3.adapter_fc2.bias", "layers.4.adapter_fc1.weight", "layers.4.adapter_fc1.bias", "layers.4.adapter_fc2.weight", "layers.4.adapter_fc2.bias", "layers.5.adapter_fc1.weight", "layers.5.adapter_fc1.bias", "layers.5.adapter_fc2.weight", "layers.5.adapter_fc2.bias", "layers.6.adapter_fc1.weight", "layers.6.adapter_fc1.bias", "layers.6.adapter_fc2.weight", "layers.6.adapter_fc2.bias", "layers.7.adapter_fc1.weight", "layers.7.adapter_fc1.bias", "layers.7.adapter_fc2.weight", "layers.7.adapter_fc2.bias", "layers.8.adapter_fc1.weight", "layers.8.adapter_fc1.bias", "layers.8.adapter_fc2.weight", "layers.8.adapter_fc2.bias", "layers.9.adapter_fc1.weight", "layers.9.adapter_fc1.bias", "layers.9.adapter_fc2.weight", "layers.9.adapter_fc2.bias", "layers.10.adapter_fc1.weight", "layers.10.adapter_fc1.bias", "layers.10.adapter_fc2.weight", "layers.10.adapter_fc2.bias", "layers.11.adapter_fc1.weight", "layers.11.adapter_fc1.bias", "layers.11.adapter_fc2.weight", "layers.11.adapter_fc2.bias", "layers.12.adapter_fc1.weight", "layers.12.adapter_fc1.bias", "layers.12.adapter_fc2.weight", "layers.12.adapter_fc2.bias", "layers.13.adapter_fc1.weight", "layers.13.adapter_fc1.bias", "layers.13.adapter_fc2.weight", "layers.13.adapter_fc2.bias", "layers.14.adapter_fc1.weight", "layers.14.adapter_fc1.bias", "layers.14.adapter_fc2.weight", "layers.14.adapter_fc2.bias", "layers.15.adapter_fc1.weight", "layers.15.adapter_fc1.bias", "layers.15.adapter_fc2.weight", "layers.15.adapter_fc2.bias", "layers.16.adapter_fc1.weight", "layers.16.adapter_fc1.bias", "layers.16.adapter_fc2.weight", "layers.16.adapter_fc2.bias", "layers.17.adapter_fc1.weight", "layers.17.adapter_fc1.bias", "layers.17.adapter_fc2.weight", "layers.17.adapter_fc2.bias", "layers.18.adapter_fc1.weight", "layers.18.adapter_fc1.bias", "layers.18.adapter_fc2.weight", "layers.18.adapter_fc2.bias", "layers.19.adapter_fc1.weight", "layers.19.adapter_fc1.bias", "layers.19.adapter_fc2.weight", "layers.19.adapter_fc2.bias", "layers.20.adapter_fc1.weight", "layers.20.adapter_fc1.bias", "layers.20.adapter_fc2.weight", "layers.20.adapter_fc2.bias", "layers.21.adapter_fc1.weight", "layers.21.adapter_fc1.bias", "layers.21.adapter_fc2.weight", "layers.21.adapter_fc2.bias", "layers.22.adapter_fc1.weight", "layers.22.adapter_fc1.bias", "layers.22.adapter_fc2.weight", "layers.22.adapter_fc2.bias", "layers.23.adapter_fc1.weight", "layers.23.adapter_fc1.bias", "layers.23.adapter_fc2.weight", "layers.23.adapter_fc2.bias", "layers.24.adapter_fc1.weight", "layers.24.adapter_fc1.bias", "layers.24.adapter_fc2.weight", "layers.24.adapter_fc2.bias", "layers.25.adapter_fc1.weight", "layers.25.adapter_fc1.bias", "layers.25.adapter_fc2.weight", "layers.25.adapter_fc2.bias", "layers.26.adapter_fc1.weight", "layers.26.adapter_fc1.bias", "layers.26.adapter_fc2.weight", "layers.26.adapter_fc2.bias", "layers.27.adapter_fc1.weight", "layers.27.adapter_fc1.bias", "layers.27.adapter_fc2.weight", "layers.27.adapter_fc2.bias", "layers.28.adapter_fc1.weight", "layers.28.adapter_fc1.bias", "layers.28.adapter_fc2.weight", "layers.28.adapter_fc2.bias", "layers.29.adapter_fc1.weight", "layers.29.adapter_fc1.bias", "layers.29.adapter_fc2.weight", "layers.29.adapter_fc2.bias","contact_head.regression.weight", "contact_head.regression.bias"}
        error_msgs = []
        ...
        if expected_missing - found_keys:
            warnings.warn(
                "Regression or Adapters weights not found, predicting contacts will not produce correct results."
            )
...
def load_model_and_alphabet_core_classic(model_name, model_data, finetuning: str = "no finetuning", adapters_layer: int = 20, rank_LoRA: int = 6, gradient_checkpointing: int = None, regression_data=None):
    if regression_data is not None:
        model_data["model"].update(regression_data["model"])

    if model_name.startswith("esm2"):
        model, alphabet, model_state = _load_model_and_alphabet_core_classic_v2(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing)
    else:
        model, alphabet, model_state = _load_model_and_alphabet_core_v1(model_data, finetuning, adapters_layer, rank_LoRA, gradient_checkpointing)
